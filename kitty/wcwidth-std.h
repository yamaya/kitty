...
wcwidth_std(int32_t code) {
    ...
    // 東アジアの曖昧な幅（文脈により文字幅が変わる） (869 codepoints) {{{
    case 0xa1:
        return -2;
    case 0xa4:
        return -2;
    ...
    // UNICODE文字データベースに未登録 (766326 codepoints) {{{
    case 0x378 ... 0x379:
        return -4;
    case 0x380 ... 0x383:
        return -4;
